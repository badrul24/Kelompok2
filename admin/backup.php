...
?>
  <html lang="en" data-bs-theme="dark">
    <head><script src="https://getbootstrap.com/docs/5.3/assets/js/color-modes.js"></script>
      ...
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Teknologi Informasi</a>
        ...
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="index.php?p=home">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="min-height: 93.2vh;">
